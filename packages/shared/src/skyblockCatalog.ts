...
export const SKYBLOCK_CATALOG: CatalogEntry[] = [
  { id: 'wheat', name: 'Wheat', collection: 'farming', color: '#e8c84a', npcSell: 6, enchanted: true, enchantedName: 'Enchanted Hay Bale', minion: false },
  { id: 'seeds', name: 'Seeds', collection: 'farming', color: '#c4a832', npcSell: 3, enchanted: true, enchantedName: 'Enchanted Seeds', minion: false },
  ...
  { id: 'coal', name: 'Coal', collection: 'mining', color: '#222222', npcSell: 2, enchanted: true, minion: false },
  { id: 'iron_ore', name: 'Iron Ore', collection: 'mining', color: '#c0a080', npcSell: 3, enchanted: false, minion: false },
  { id: 'iron_ingot', name: 'Iron Ingot', collection: 'mining', color: '#d8d8d8', npcSell: 3, enchanted: true, minion: false },
  { id: 'gold_ingot', name: 'Gold Ingot', collection: 'mining', color: '#ffaa00', npcSell: 4, enchanted: true, minion: false },
  { id: 'diamond', name: 'Diamond', collection: 'mining', color: '#55ffff', npcSell: 8, enchanted: true, minion: false },
  { id: 'emerald', name: 'Emerald', collection: 'mining', color: '#55ff55', npcSell: 6, enchanted: true, minion: false },
  { id: 'lapis', name: 'Lapis Lazuli', collection: 'mining', color: '#5555ff', npcSell: 1, enchanted: true, minion: false },
  { id: 'redstone', name: 'Redstone', collection: 'mining', color: '#ff5555', npcSell: 1, enchanted: true, minion: false },
