...
export function registerDungeonGear(): void {
  const entries: ItemDef[] = [
    ...
    gear('fuming_potato_book', 'Fuming Potato Book', 'LEGENDARY', 'MATERIAL', { color: '#ff8800', description: 'Apply after 10 Hot Potato Books for 5 more upgrades.' }),
    gear('stone_spicy', 'Spicy Stone', 'RARE', 'MATERIAL', { color: '#aa0000', description: 'Reforge a weapon to Spicy.' }),
    gear('stone_sharp', 'Sharp Stone', 'RARE', 'MATERIAL', { color: '#aaaaaa', description: 'Reforge a weapon to Sharp.' }),
    gear('stone_heroic', 'Heroic Stone', 'RARE', 'MATERIAL', { color: '#55ffff', description: 'Reforge a weapon to Heroic.' }),
    gear('stone_fierce', 'Fierce Stone', 'RARE', 'MATERIAL', { color: '#ff5555', description: 'Reforge armor to Fierce.' }),
    gear('stone_pure', 'Pure Stone', 'RARE', 'MATERIAL', { color: '#ffffff', description: 'Reforge armor to Pure.' }),
    gear('stone_wise', 'Wise Stone', 'RARE', 'MATERIAL', { color: '#5555ff', description: 'Reforge armor to Wise.' }),
    gear('stone_titanic', 'Titanic Stone', 'RARE', 'MATERIAL', { color: '#55ff55', description: 'Reforge armor to Titanic.' }),
    gear('stone_itchy', 'Itchy Stone', 'RARE', 'MATERIAL', { color: '#ff55ff', description: 'Reforge an accessory to Itchy.' }),
    gear('stone_bizarre', 'Bizarre Stone', 'RARE', 'MATERIAL', { color: '#aa00aa', description: 'Reforge an accessory to Bizarre.' }),
    gear('stone_fleet', 'Fleet Stone', 'RARE', 'MATERIAL', { color: '#ffaa00', description: 'Reforge a tool to Fleet.' }),
    gear('dragon_claw', 'Dragon Claw', 'RARE', 'MATERIAL', { color: '#aa44ff', description: 'Reforge a weapon to Fabled.' }),
    gear('withered_catalyst', 'Withered Catalyst', 'EPIC', 'MATERIAL', { color: '#440044', description: 'Reforge a weapon to Withered.' }),
    gear('necrotic_crystal', 'Necrotic Crystal', 'RARE', 'MATERIAL', { color: '#55aa55', description: 'Reforge armor to Necrotic.' }),
    gear('renowned_bead', 'Renowned Bead', 'EPIC', 'MATERIAL', { color: '#ffaa00', description: 'Reforge an accessory to Renowned.' }),
    gear('textbook', 'Textbook', 'LEGENDARY', 'MATERIAL', { color: '#55aaff', stackSize: 1, description: 'Pet item. Hold it to grant +20% Pet XP.' }),
    gear('pet_item_exp_share', 'Exp Share', 'EPIC', 'MATERIAL', { color: '#55ff55', stackSize: 1, description: 'Pet item. Hold it for +10% Pet XP and Intelligence.' }),
