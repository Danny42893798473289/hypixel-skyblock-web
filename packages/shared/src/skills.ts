...
export const SKILLS: Record<SkillId, SkillDef> = {
  ...
  foraging: {
    ...
    levelRewards: { ...DEFAULT_LEVEL_REWARDS, 5: { coins: 500, items: [{ itemId: 'stone_axe', qty: 1 }] }, 15: { coins: 3000, items: [{ itemId: 'jungle_axe', qty: 1 }] } },
  },
  fishing: {
    id: 'fishing',
    name: 'Fishing',
    ...
    levelRewards: { ...DEFAULT_LEVEL_REWARDS, 5: { coins: 500, items: [{ itemId: 'fishing_rod', qty: 1 }] }, 15: { coins: 3000, items: [{ itemId: 'raw_fish', qty: 16 }] } },
  },
  enchanting: { id: 'enchanting', name: 'Enchanting', color: '#aa55ff', description: 'Improve magical abilities and enchant gear.', maxLevel: 60, rewardPerLevel: { intelligence: 1 }, levelRewards: { ...DEFAULT_LEVEL_REWARDS, 10: { coins: 1500, items: [{ itemId: 'lapis', qty: 16 }] } } },
  alchemy: { id: 'alchemy', name: 'Alchemy', color: '#ff55ff', description: 'Brew stronger and longer-lasting potions.', maxLevel: 50, rewardPerLevel: { intelligence: 1 }, levelRewards: { ...DEFAULT_LEVEL_REWARDS, 5: { coins: 500 }, 15: { coins: 3000 } } },
  taming: { id: 'taming', name: 'Taming', color: '#55ff55', description: 'Level pets faster and improve Pet Luck.', maxLevel: 60, rewardPerLevel: { petLuck: 1 }, levelRewards: { ...DEFAULT_LEVEL_REWARDS, 10: { coins: 1500 }, 25: { coins: 8000 } } },
  carpentry: { id: 'carpentry', name: 'Carpentry', color: '#ffaa00', description: 'Craft decorative furniture.', maxLevel: 50, rewardPerLevel: { health: 1 }, levelRewards: { ...DEFAULT_LEVEL_REWARDS } },
