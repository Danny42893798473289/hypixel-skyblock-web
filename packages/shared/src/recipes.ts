...
RECIPES.push(
  ...
  { id: 'cactus_knife', name: 'Cactus Knife', result: { itemId: 'cactus_knife', qty: 1 }, ingredients: [{ itemId: 'cactus', qty: 128 }, { itemId: 'stick', qty: 2 }], unlockCollection: 'cactus', unlockAmount: 500 },
  { id: 'cocoa_chopper', name: 'Cocoa Chopper', result: { itemId: 'cocoa_chopper', qty: 1 }, ingredients: [{ itemId: 'cocoa_beans', qty: 128 }, { itemId: 'stick', qty: 2 }], unlockCollection: 'cocoa_beans', unlockAmount: 500 },
  { id: 'fungi_cutter', name: 'Fungi Cutter', result: { itemId: 'fungi_cutter', qty: 1 }, ingredients: [{ itemId: 'mushroom', qty: 128 }, { itemId: 'stick', qty: 2 }], unlockCollection: 'mushroom', unlockAmount: 500 },
  { id: 'pumpkin_dicer', name: 'Pumpkin Dicer', result: { itemId: 'pumpkin_dicer', qty: 1 }, ingredients: [{ itemId: 'pumpkin', qty: 256 }, { itemId: 'enchanted_wheat', qty: 2 }], unlockCollection: 'pumpkin', unlockAmount: 1000 },
  { id: 'mathematical_hoe', name: 'Mathematical Hoe Blueprint', result: { itemId: 'mathematical_hoe', qty: 1 }, ingredients: [{ itemId: 'enchanted_wheat', qty: 4 }, { itemId: 'gold_ingot', qty: 32 }], unlockCollection: 'wheat', unlockAmount: 5000, unlockSkill: { skill: 'farming', level: 20 } },
  { id: 'melon_dicer', name: 'Melon Dicer', result: { itemId: 'melon_dicer', qty: 1 }, ingredients: [{ itemId: 'melon', qty: 256 }, { itemId: 'enchanted_wheat', qty: 2 }], unlockCollection: 'melon', unlockAmount: 1000 },
  { id: 'sugar_cane_hoe', name: 'Theoretical Hoe of Sugar Cane', result: { itemId: 'sugar_cane_hoe', qty: 1 }, ingredients: [{ itemId: 'enchanted_wheat', qty: 8 }, { itemId: 'enchanted_diamond', qty: 4 }], unlockCollection: 'sugar_cane', unlockAmount: 10000, unlockSkill: { skill: 'farming', level: 25 } },
  { id: 'nether_wart_hoe', name: 'Theoretical Hoe of Warts', result: { itemId: 'nether_wart_hoe', qty: 1 }, ingredients: [{ itemId: 'nether_wart', qty: 512 }, { itemId: 'enchanted_diamond', qty: 4 }], unlockCollection: 'nether_wart', unlockAmount: 10000, unlockSkill: { skill: 'farming', level: 25 } },
  { id: 'challenging_rod', name: 'Challenging Rod', result: { itemId: 'challenging_rod', qty: 1 }, ingredients: [{ itemId: 'fishing_rod', qty: 1 }, { itemId: 'enchanted_string', qty: 2 }], unlockCollection: 'string', unlockAmount: 500, unlockSkill: { skill: 'fishing', level: 8 } },
  { id: 'rod_of_the_sea', name: 'Rod of the Sea', result: { itemId: 'rod_of_the_sea', qty: 1 }, ingredients: [{ itemId: 'challenging_rod', qty: 1 }, { itemId: 'enchanted_iron', qty: 4 }], unlockCollection: 'string', unlockAmount: 2000, unlockSkill: { skill: 'fishing', level: 14 } },
  { id: 'auger_rod', name: 'Auger Rod', result: { itemId: 'auger_rod', qty: 1 }, ingredients: [{ itemId: 'rod_of_the_sea', qty: 1 }, { itemId: 'blaze_rod', qty: 64 }, { itemId: 'enchanted_iron', qty: 8 }], unlockCollection: 'blaze_rod', unlockAmount: 500, unlockSkill: { skill: 'fishing', level: 18 } },
  { id: 'magma_rod', name: 'Magma Rod', result: { itemId: 'magma_rod', qty: 1 }, ingredients: [{ itemId: 'auger_rod', qty: 1 }, { itemId: 'enchanted_diamond', qty: 4 }], unlockSkill: { skill: 'fishing', level: 22 } },
  { id: 'inferno_rod', name: 'Inferno Rod', result: { itemId: 'inferno_rod', qty: 1 }, ingredients: [{ itemId: 'magma_rod', qty: 1 }, { itemId: 'enchanted_diamond_block', qty: 1 }, { itemId: 'blaze_rod', qty: 128 }], unlockSkill: { skill: 'fishing', level: 28 } },
);
