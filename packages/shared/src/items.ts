...
Object.assign(ITEMS, {
  ...
  gemstone_amethyst: skyblockItem('gemstone_amethyst', 'Rough Amethyst Gemstone', 'COMMON', 'MATERIAL', { color: '#aa55ff', npcSell: 3 }),
  gemstone_sapphire: skyblockItem('gemstone_sapphire', 'Rough Sapphire Gemstone', 'COMMON', 'MATERIAL', { color: '#4488ff', npcSell: 3 }),
  gemstone_amber: skyblockItem('gemstone_amber', 'Rough Amber Gemstone', 'COMMON', 'MATERIAL', { color: '#ff8800', npcSell: 3 }),
  gemstone_topaz: skyblockItem('gemstone_topaz', 'Rough Topaz Gemstone', 'COMMON', 'MATERIAL', { color: '#ffcc00', npcSell: 3 }),
  gemstone_jasper: skyblockItem('gemstone_jasper', 'Rough Jasper Gemstone', 'COMMON', 'MATERIAL', { color: '#cc6644', npcSell: 3 }),
  flawless_ruby: skyblockItem('flawless_ruby', 'Flawless Ruby Gemstone', 'UNCOMMON', 'MATERIAL', { color: '#d81b45', npcSell: 240 }),
  flawless_jade: skyblockItem('flawless_jade', 'Flawless Jade Gemstone', 'UNCOMMON', 'MATERIAL', { color: '#2ec27e', npcSell: 240 }),
  flawless_amethyst: skyblockItem('flawless_amethyst', 'Flawless Amethyst Gemstone', 'UNCOMMON', 'MATERIAL', { color: '#aa55ff', npcSell: 240 }),
  flawless_sapphire: skyblockItem('flawless_sapphire', 'Flawless Sapphire Gemstone', 'UNCOMMON', 'MATERIAL', { color: '#4488ff', npcSell: 240 }),
  flawless_amber: skyblockItem('flawless_amber', 'Flawless Amber Gemstone', 'UNCOMMON', 'MATERIAL', { color: '#ff8800', npcSell: 240 }),
  flawless_topaz: skyblockItem('flawless_topaz', 'Flawless Topaz Gemstone', 'UNCOMMON', 'MATERIAL', { color: '#ffcc00', npcSell: 240 }),
  flawless_jasper: skyblockItem('flawless_jasper', 'Flawless Jasper Gemstone', 'UNCOMMON', 'MATERIAL', { color: '#cc6644', npcSell: 240 }),
  perfect_ruby: skyblockItem('perfect_ruby', 'Perfect Ruby Gemstone', 'RARE', 'MATERIAL', { color: '#d81b45', npcSell: 1200 }),
  perfect_jade: skyblockItem('perfect_jade', 'Perfect Jade Gemstone', 'RARE', 'MATERIAL', { color: '#2ec27e', npcSell: 1200 }),
  perfect_amethyst: skyblockItem('perfect_amethyst', 'Perfect Amethyst Gemstone', 'RARE', 'MATERIAL', { color: '#aa55ff', npcSell: 1200 }),
  perfect_sapphire: skyblockItem('perfect_sapphire', 'Perfect Sapphire Gemstone', 'RARE', 'MATERIAL', { color: '#4488ff', npcSell: 1200 }),
  perfect_amber: skyblockItem('perfect_amber', 'Perfect Amber Gemstone', 'RARE', 'MATERIAL', { color: '#ff8800', npcSell: 1200 }),
  perfect_topaz: skyblockItem('perfect_topaz', 'Perfect Topaz Gemstone', 'RARE', 'MATERIAL', { color: '#ffcc00', npcSell: 1200 }),
  perfect_jasper: skyblockItem('perfect_jasper', 'Perfect Jasper Gemstone', 'RARE', 'MATERIAL', { color: '#cc6644', npcSell: 1200 }),
  ...
  livid_dagger: skyblockItem('livid_dagger', 'Livid Dagger', 'LEGENDARY', 'SWORD', { color: '#ffaa00', damage: 210, stats: { strength: 60, critChance: 100, critDamage: 50, attackSpeed: 100 }, ability: { name: 'Throw', description: 'Throw the dagger for a long-range hit. Melee attacks from behind deal double damage.', manaCost: 50, damage: 900, scaling: 0.15, cooldownSec: 5 } }),
  ...
  iron_helmet: skyblockItem('iron_helmet', 'Iron Helmet', 'COMMON', 'HELMET', { color: '#d8d8d8', stats: { health: 10, defense: 15 }, npcSell: 12 }),
  iron_chestplate: skyblockItem('iron_chestplate', 'Iron Chestplate', 'COMMON', 'CHESTPLATE', { color: '#d8d8d8', stats: { health: 20, defense: 40 }, npcSell: 20 }),
  iron_leggings: skyblockItem('iron_leggings', 'Iron Leggings', 'COMMON', 'LEGGINGS', { color: '#d8d8d8', stats: { health: 15, defense: 30 }, npcSell: 18 }),
  iron_boots: skyblockItem('iron_boots', 'Iron Boots', 'COMMON', 'BOOTS', { color: '#d8d8d8', stats: { health: 5, defense: 10 }, npcSell: 10 }),
  diamond_helmet: skyblockItem('diamond_helmet', 'Diamond Helmet', 'UNCOMMON', 'HELMET', { color: '#55ffff', stats: { health: 20, defense: 25 }, npcSell: 40 }),
  diamond_chestplate: skyblockItem('diamond_chestplate', 'Diamond Chestplate', 'UNCOMMON', 'CHESTPLATE', { color: '#55ffff', stats: { health: 40, defense: 60 }, npcSell: 64 }),
  diamond_leggings: skyblockItem('diamond_leggings', 'Diamond Leggings', 'UNCOMMON', 'LEGGINGS', { color: '#55ffff', stats: { health: 30, defense: 45 }, npcSell: 56 }),
  diamond_boots: skyblockItem('diamond_boots', 'Diamond Boots', 'UNCOMMON', 'BOOTS', { color: '#55ffff', stats: { health: 10, defense: 15 }, npcSell: 32 }),
  ...
  bits_talisman: skyblockItem('bits_talisman', 'Bits Talisman', 'RARE', 'ACCESSORY', { color: '#55ff55', stats: { magicFind: 2, intelligence: 5 }, description: 'Purchased from the Community Shop with Bits.' }),
...
Object.assign(ITEMS, {
  ...
  reaper_falchion: skyblockItem('reaper_falchion', 'Reaper Falchion', 'EPIC', 'SWORD', { color: '#225522', damage: 140, stats: { strength: 80, critDamage: 20 }, description: 'Upgraded Revenant Falchion. Unlocked at Revenant Slayer 3.' }),
  ...
  juju_shortbow: skyblockItem('juju_shortbow', 'Juju Shortbow', 'LEGENDARY', 'BOW', { damage: 310, stats: { strength: 40, critDamage: 110, attackSpeed: 50 }, description: 'Shortbow. Ignores mob defense and fires faster.' }),
  terminator: skyblockItem('terminator', 'Terminator', 'MYTHIC', 'BOW', { damage: 310, stats: { strength: 50, critDamage: 250, attackSpeed: 40 }, ability: { name: 'Salvation', description: 'Fire three arrows at once and charge a powerful beam.', manaCost: 150, damage: 1200, scaling: 0.25, cooldownSec: 8 } }),
  ...
  challenging_rod: skyblockItem('challenging_rod', 'Challenging Rod', 'UNCOMMON', 'FISHING_ROD', { color: '#55aa55', toolType: 'rod', toolTier: 2, stats: { seaCreatureChance: 2 }, description: 'A rod that attracts tougher sea creatures.' }),
  rod_of_the_sea: skyblockItem('rod_of_the_sea', 'Rod of the Sea', 'RARE', 'FISHING_ROD', { color: '#5555ff', toolType: 'rod', toolTier: 3, stats: { seaCreatureChance: 3.5 }, description: 'A refined rod attuned to ocean tides.' }),
  auger_rod: skyblockItem('auger_rod', 'Auger Rod', 'EPIC', 'FISHING_ROD', { color: '#ff5555', toolType: 'rod', toolTier: 4, stats: { seaCreatureChance: 4.5 }, description: 'Built for lava fishing in the Crimson Isle.' }),
  magma_rod: skyblockItem('magma_rod', 'Magma Rod', 'EPIC', 'FISHING_ROD', { color: '#ff8800', toolType: 'rod', toolTier: 4, stats: { seaCreatureChance: 5 }, description: 'Forged in magma. Superior lava fishing rod.' }),
  inferno_rod: skyblockItem('inferno_rod', 'Inferno Rod', 'LEGENDARY', 'FISHING_ROD', { color: '#ffaa00', toolType: 'rod', toolTier: 6, stats: { seaCreatureChance: 8 }, description: 'The ultimate lava fishing rod.' }),
  cactus_knife: skyblockItem('cactus_knife', 'Cactus Knife', 'UNCOMMON', 'HOE', { color: '#00aa00', toolType: 'hoe', toolTier: 3, stats: { farmingFortune: 20 }, description: 'Specialized for cactus farming.' }),
  cocoa_chopper: skyblockItem('cocoa_chopper', 'Cocoa Chopper', 'UNCOMMON', 'AXE', { color: '#885522', toolType: 'axe', toolTier: 3, stats: { farmingFortune: 20 }, description: 'Designed for cocoa bean farming.' }),
  fungi_cutter: skyblockItem('fungi_cutter', 'Fungi Cutter', 'RARE', 'HOE', { color: '#aa3333', toolType: 'hoe', toolTier: 3, stats: { farmingFortune: 30 }, description: 'Cuts mushrooms with surgical precision.' }),
  pumpkin_dicer: skyblockItem('pumpkin_dicer', 'Pumpkin Dicer', 'EPIC', 'AXE', { color: '#ffaa00', toolType: 'axe', toolTier: 4, stats: { farmingFortune: 50 }, description: 'Specialized tool for farming pumpkins.' }),
  sugar_cane_hoe: skyblockItem('sugar_cane_hoe', 'Theoretical Hoe of Sugar Cane', 'LEGENDARY', 'HOE', { color: '#aaffaa', toolType: 'hoe', toolTier: 5, stats: { farmingFortune: 75 }, description: 'A legendary hoe optimized for sugar cane.' }),
  nether_wart_hoe: skyblockItem('nether_wart_hoe', 'Theoretical Hoe of Warts', 'LEGENDARY', 'HOE', { color: '#aa0000', toolType: 'hoe', toolTier: 5, stats: { farmingFortune: 75 }, description: 'A legendary hoe optimized for nether wart.' }),
  ...
  nether_wart: skyblockItem('nether_wart', 'Nether Wart', 'COMMON', 'MATERIAL', { color: '#aa0000', npcSell: 4 }),
});
